...
Carousel.prototype = {
    ...
    pageActiveColor: function() { //绘制圆点
        document.getElementById(this.wrapId + "_active").removeAttribute("id")
        document.getElementsByClassName(this.wrapId + "_pagination")[this.activePage].id = this.wrapId + "_active";
    },
    ...
    setTime: function() { //自动播放
        let wrapId = this.wrapId; //解决this绑定丢失    将包含this的函数当做参数绑定时，this的指向会发生改变，这里如果不重新定义 this.wrapId指向的是window
